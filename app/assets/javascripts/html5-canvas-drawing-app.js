...
mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.offsetTop;
		...
		init = function () {
			...
			crayonImage.src = "/assets/crayon-outline.png";

			markerImage.onload = resourceLoaded;
			markerImage.src = "/assets/marker-outline.png";

			eraserImage.onload = resourceLoaded;
			eraserImage.src = "/assets/eraser-outline.png";

			crayonBackgroundImage.onload = resourceLoaded;
			crayonBackgroundImage.src = "/assets/crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "/assets/marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "/assets/eraser-background.png";

			crayonTextureImage.onload = resourceLoaded;
			crayonTextureImage.src = "/assets/crayon-texture.png";

			outlineImage.onload = resourceLoaded;
			outlineImage.src = "/assets/blankcanvas.png";
		};
